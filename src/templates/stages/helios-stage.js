...
class HeliosStage extends Subject {
    constructor() {
        super();
        this.composites = [];
        ...
        this.maxScore = 3;
        this.isOver = false;
        this.highScore = window.localStorage.getItem("stage11") || 0

        this.bird = new CowBird(BIRD_X, BIRD_Y, 15);
        ...
        this.iceSquare1 = new IceSquare(920, 440, OBSTACLE_SQUARE_LENGTH, OBSTACLE_SQUARE_LENGTH)
        this.pig1 = new CorporalPig(860, 380, PIG_SIZE_CORPORAL)
        this.pig2 = new MinionPig(800, 440, PIG_SIZE_MINION)
        this.pig3 = new MinionPig(980, 440, PIG_SIZE_MINION)
      ...
      //  this.composites.push(this.pig.getBody());
        ...
        document.getElementById('rb-stage11').style.display = "flex";
        document.getElementById('rb-stage11-red1').style.display = "flex";
        document.getElementById('rb-stage11-red2').style.display = "flex";
        document.getElementById('rb-stage11-red3').style.display = "flex";
        document.getElementById("helios-heading").style.animation = "fade 5s linear";
        document.getElementById("helios-battlecry").style.animation = "fade 5s linear";
    ...
    checkHighScore() {
        if (this.getStars() > this.highScore) {
            ...
            window.localStorage.setItem("stage11", this.score)
            var stars = ""
            ...
            document.getElementById('score11').innerHTML = `high record : `+stars;
            document.getElementById('stage11-star').innerHTML = stars;
        }
    }
    ...
    firing(world) {
        ...
        if (this.remainingBirds == 3) {
            document.getElementById('rb-stage11-red1').style.display = "none";
        } else if (this.remainingBirds == 2) {
            document.getElementById('rb-stage11-red2').style.display = "none";
        } else if (this.remainingBirds == 1) {
            document.getElementById('rb-stage11-red3').style.display = "none";
        }
        ...
        if (this.remainingBirds == 0) {
            ...
            let newBird = new CowBird(BIRD_X, BIRD_Y, 15);
            this.bird = newBird;
            bird = this.bird;
