...
class ScheriaStage extends Subject {
    constructor() {
        super();
        this.composites = [];
        ...
        this.maxScore = 3;
        this.isOver = false;
        this.highScore = window.localStorage.getItem("stage13") || 0

        this.bird = new GoldBird(BIRD_X, BIRD_Y, 15);
        ...
        this.steelSquare5 = new SteelSquare(860, 380, OBSTACLE_SQUARE_LENGTH, OBSTACLE_SQUARE_LENGTH)
       
        this.steelSquare6 = new SteelSquare(920, 380, OBSTACLE_SQUARE_LENGTH, OBSTACLE_SQUARE_LENGTH)
        this.steelSquare7 = new SteelSquare(980, 380, OBSTACLE_SQUARE_LENGTH, OBSTACLE_SQUARE_LENGTH)
        this.pig1 = new CorporalPig(860, 440, PIG_SIZE_CORPORAL)
        this.pig2 = new CorporalPig(980, 440, PIG_SIZE_MINION)
        this.pig3 = new KingPig(920, 320, PIG_SIZE_KING)
      ...
      //  this.composites.push(this.pig.getBody());
        ...
        document.getElementById('rb-stage13').style.display = "flex";
        document.getElementById('rb-stage13-red1').style.display = "flex";
        document.getElementById('rb-stage13-red2').style.display = "flex";
        document.getElementById('rb-stage13-red3').style.display = "flex";
        document.getElementById("scheria-heading").style.animation = "fade 5s linear";
        document.getElementById("scheria-battlecry").style.animation = "fade 5s linear";
    ...
    checkHighScore() {
        if (this.getStars() > this.highScore) {
            ...
            window.localStorage.setItem("stage13", this.score)
            var stars = ""
            ...
            document.getElementById('score13').innerHTML = `high record : `+stars;
            document.getElementById('stage13-star').innerHTML = stars;
        }
    }
    ...
    firing(world) {
        ...
        if (this.remainingBirds == 3) {
            document.getElementById('rb-stage13-red1').style.display = "none";
        } else if (this.remainingBirds == 2) {
            document.getElementById('rb-stage13-red2').style.display = "none";
        } else if (this.remainingBirds == 1) {
            document.getElementById('rb-stage13-red3').style.display = "none";
        }
        ...
        if (this.remainingBirds == 0) {
            ...
            let newBird = new GoldBird(BIRD_X, BIRD_Y, 15);
            this.bird = newBird;
            bird = this.bird;
